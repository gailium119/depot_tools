...
class GitWrapper(SCMWrapper):
    ...
    def _Clone(self, revision, url, options):
        ...
        if newauth.Enabled():
            ...
            # The provided URL might be a local cache directory, so we
            # need the actual remote URL.
            #
            # If GetActualRemoteURL returns None fall back on the url.
            git_auth.ConfigureGlobal('/',
                                     self.GetActualRemoteURL(options) or url)
