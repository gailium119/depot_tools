...
def CMDsplit(parser, args):
    ...
    parser.add_option('--from-file',
                      type='str',
                      default=None,
                      help='If present, load the split CLs from a file instead '
                      'of computing a splitting. The file must have the same '
                      'format as the files saved by this script during a dry '
                      'run or when a splitting is rejected.\n\n')
