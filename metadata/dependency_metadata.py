...
class DependencyMetadata:
    ...
    def validate(self, source_file_dir: str,
        ...
        # fields e.g. 'CVE-2024-12345: desciption'.
        ...
        if mitigated_values is not None:
            ...
            # Reported as their own field e.g. 'CVE-2024-12345: desciption'.
            mitigated_entries = set(self.mitigated.keys())

            missing_descriptions = mitigated_ids - mitigated_entries
            if missing_descriptions:
                results.append(vr.ValidationWarning(
                    reason="Missing descriptions for vulnerability IDs",
                    additional=[f"Add descriptions for: {util.quoted(missing_descriptions)}"]
                ))
            ...
            if extra_descriptions:
                results.append(vr.ValidationWarning(
                    ...
                    additional=[f"List these IDs in the 'Mitigated:' field: {util.quoted(extra_descriptions)}"]
                ))
