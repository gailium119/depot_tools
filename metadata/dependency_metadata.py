...
class DependencyMetadata:
    ...
    def _assess_required_fields(self, allow_reciprocal_licenses: bool = False) -> Set[field_types.MetadataField]:
    ...
    def validate(self, source_file_dir: str,
        ...
        for field, value in self._metadata.items():
            ...
            if isinstance(source_field, license_util.LicenseField):
                field_result = source_field.validate(value, allow_reciprocal_licenses=allow_reciprocal_licenses)
            else:
        ...
        required_fields = self._assess_required_fields(allow_reciprocal_licenses=allow_reciprocal_licenses)
