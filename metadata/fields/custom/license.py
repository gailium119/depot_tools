  ...
  def validate(self, value: str) -> Optional[vr.ValidationResult]:
    ...
    for license, allowed in licenses:
      ...
      if BAD_DELIMITERS_REGEX.search(license):
        bad_values_in_license = [c for c in BAD_DELIMITERS if c in license]
        many_bad = len(bad_values_in_license) > 1
        return vr.ValidationError(
                ...
                # Try and preemptivly address the root cause of this behaviour,
