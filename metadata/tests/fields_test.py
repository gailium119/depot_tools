...
class FieldValidationTest(unittest.TestCase):
    ...
    def test_parse_mitigated(self):
        ...
        self.assertDictEqual(
            ...
            {'CVE-2011-4061': 'This copy of DependencyA only includes rainbows\nthat spill beautifully over multiple lines and are handled\n ~~ Perfectly ~~\nEven: this line with colons that mentions CVE-2000-2000: an unrelated cve.', 'CVE-2024-7255': 'This copy of DependencyA only includes unicorns', 'CVE-2024-7256': "This also doesn't apply because of good reasons"},
        )
...
"""
        ...
        self.assertTrue(
            any(
                result.get_tag("field") == "Mitigated"
                and isinstance(result, metadata.validation_result.ValidationWarning)
