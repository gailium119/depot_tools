...
class _PresubmitResultLocation:
    ...
    #
    # path MUST be relative to the repo root or COMMIT_MSG_PATH to indicate
    # the errors/warnings are against the commit message (a.k.a cl description).
    file_path: str
...
class _PresubmitResult(object):
    ...
    def __init__(self,
        ...
        Args:
            ...
            locations: The locations indicates where the errors occurred.
        """
