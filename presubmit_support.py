...
class _PresubmitResultLocation:
    ...
    #
    # MUST be relative path or '/COMMIT_MSG'
    file_path: str
    ...
    def validate(self):
        ...
        if self.file_path != '/COMMIT_MSG' and os.path.isabs(self.file_path):
            raise ValueError(
...
class _PresubmitResult(object):
    ...
    def __init__(self,
        ...
        locations: The locations indicating where the errors/warnings occurred.
        """
    ...
    def handle(self, out_file=None):
        ...
        if self._locations:
            ...
            for loc in self._locations:
                ...
                if loc.start_line and loc.start_col:
                    out_file.write(
