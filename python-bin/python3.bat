...
IF NOT EXISTS "%PARENT_DIR%\python3_bin_reldir.txt" (
  echo "python3_bin_reldir.txt not found. need to initialize depot_tools by"
  echo "running gclient or update_depot_tools"
  exit /b 1
)
