...
# Information representing one CL
...
class CLInfo:
    ...
    # Print a nicely formatted version of the dataclass to a string
    def ToString(self):
...
def SplitCl(description_file, comment_file, changelist, cmd_upload, dry_run,
    ...
    try:
        ...
        cl_infos = CLInfoFromFODDict(files_split_by_reviewers)
