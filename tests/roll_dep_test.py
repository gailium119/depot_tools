        ...
        self._commit_git(
            'repo_1', {
                'DEPS': create_deps_content(self.git_base, {
                    ...
                    'src/third_party/multiple_revisions/src': repo2_revision
                }),
                'README.chromium': '\n'.join([
                    'Name: test repo',
                ...
                'third_party/multiple_revisions/README.chromium': '\n'.join([
...
class RollDepTest(fake_repos.FakeReposTestBase):
    ...
    def setUp(self):
        ...
        self.all_repos = [
            ...
            'src/third_party/multiple_revisions/src',
        ]
        if self.enabled:
            self.call([
    ...
    def testRollsDepWithReadme(self):
        ...
        for path in self.all_repos:
            ...
            if path == 'src/third_party/with_divider/src':
                ...
                continue
            if path == 'src/third_party/multiple_revisions/src':
                self.assertNotIn(latest_revision, contents)
                continue
